...
open class BaseActivity : AppCompatActivity() {
    ...
    fun setupActionBar(toolbar: Toolbar, title: String?, icon: Int? = null) {
        setSupportActionBar(toolbar)

        when (val drawable = icon ?: (R.drawable.ic_back_black)) {
    ...
    fun doubleBackToExit() {
        ...
        Toast.makeText(this,
            resources.getString(R.string.touch_again_to_exit),
